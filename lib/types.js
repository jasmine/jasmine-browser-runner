 ...
 * is required.
 *
 * See example usage in jasmine-browser-runner/spec/fixtures/importMap
 *
 * _Note_: This is not in the import map spec. This is a jasmine-browser setting
 * only to enable jasmine to correctly specify paths for the testing harness'
 * html.
 *
 * @name importMapInfo#moduleRootDir
 * @type string
