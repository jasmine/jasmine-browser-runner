...
Server.prototype.getSupportFiles = function() {
  var result = ['/__support__/loadScript.js'];
...
Server.prototype.jasmineJs = function() {
  return this.jasmineJsFiles.concat(this.getSupportFiles());
};

Server.prototype.userJs = async function() {
 ...
 * Starts the server.
 * @param serverOptions
 * @return {Promise<Server>} A promise that resolves to the server itself
